...
/* statistics and printing other functions*/
...
/*function for finding the median value in the array*/
unsigned char find_median(unsigned char array[], unsigned int length){
	return array[(length-1)/2];
}


/*function for finding the mean value in the array*/
...
/*function for finding the maximum value in the array*/
unsigned char find_max(unsigned char array[], unsigned int length){
	return array[length-1];
}

/*function for finding the minimum value in the array*/
unsigned char find_min(unsigned char array[], unsigned int length){
	return array[0];
}

/*function for soting the array*/
